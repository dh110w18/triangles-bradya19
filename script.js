...
document.getElementById("body1").innerHTML = message1;
...
document.getElementById("body2").innerHTML = message2;
...
document.getElementById("body3").innerHTML = 'The area of a triangle with a base of ' + this.base + 'and a height of ' + this.height + 'is equal to ' + calcArea + '\n' + message4;